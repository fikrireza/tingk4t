...
@section('title')
  <title>Tingkat | Edit Project</title>
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form action="{{ route('projects.update') }}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
          {{ csrf_field() }}
          <input type="hidden" name="id" value="{{ $findProjects->id }}">
          <div class="item form-group {{ $errors->has('name') ? 'has-error' : ''}}">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Project Name <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="E.g: Amadeo Project" required="required" type="text" value="{{ old('name', $findProjects->name) }}">
              @if($errors->has('name'))
          ...
          <div class="item form-group {{ $errors->has('location') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="location" required="required" name="location">{{ old('location', $findProjects->location) }}</textarea>
          ...
          <div class="item form-group {{ $errors->has('scope') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="scope" required="required" name="scope">{{ old('scope', $findProjects->scope)}}</textarea>
              @if($errors->has('scope'))
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <img src="{{ asset('amadeo/images/projects').'/'.$findProjects->img_large }}" alt="">
            </div>
          </div>
          <div class="item form-group">
            <label class="col-md-3"></label>
          ...
          <div class="item form-group">
            <label class="col-md-3 col-sm-3 col-xs-12"></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <img src="{{ asset('amadeo/images/projects').'/'.$findProjects->img_thumb }}" alt="">
            </div>
          </div>
          <div class="ln_solid"></div>
